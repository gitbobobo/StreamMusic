...
class WasaiCrawler:
    ...
    def search_podcast(self, keyword: str = "挖赛") -> Optional[str]:
        """
        搜索播客
    ...
    def save_to_json(self, programs: List[Dict], filename: str = "wasai_programs.json"):
        """
        保存节目列表到JSON文件
    ...
    def generate_markdown(self, programs: List[Dict], filename: str = "wasai_programs.md"):
        """
        生成Markdown格式的节目列表
